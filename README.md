...
| BST            | [Behavior sequence transformer for e-commerce recommendation in Alibaba](https://arxiv.org/pdf/1905.06874.pdf) | [Transformer 在美团搜索排序中的实践](https://zhuanlan.zhihu.com/p/161311198) ，[Transformer模型之Encoder结构在文本分类中的应用](https://mp.weixin.qq.com/s/3xOvbwRyh3bP2bEggerdDw)|
