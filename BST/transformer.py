...
if __name__ == "__main__":
    ...
    sample_encoder = Encoder(n_layers, d_model, num_heads, middle_units, max_seq_len)
    sample_encoder_output = sample_encoder(input_data, encode_padding_mask_list, training)
